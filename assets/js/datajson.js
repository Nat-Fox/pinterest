...
// Dividimos el arreglo en dos para hacer la carga de las imagenes cuando se llegue abajo haciendo scroll
var primeraCarga = data.slice(0, 19);
var segundaCarga = data.slice(20, 40);
// contar por cada append para cortarlo cuando agregue los 20 y no tener un scroll infinito
var contador = 0;


$(document).ready(function() {
    primeraCarga.forEach(function(dataImg) {
        ...
        // Verifica si el usuario llega al final de la pagina
            ...
            if ($(window).scrollTop() + $(window).height() == $(document).height()) {
                ...
                segundaCarga.forEach(function(segundaData) {
                    ...
                    $('#info').append(`
                        <div class="container">                
                            <div> 
                                <img src="dist/img/${segundaData.image_url}" class="photo" id="photo-${segundaData.id}"> 
                            </div>
                            <div class="title-photo"> 
                                ${segundaData.title}
                                <span class="content-followers">
                            ...
                            <div class="container-user"> 
                                <i class="fa fa-user-circle" aria-hidden="true"></i> 
                                <span>${segundaData.user}</span>
                                <span class="hashtag">#${segundaData.hashtag}</span>
                            </div>
                        </div>
                    `);
